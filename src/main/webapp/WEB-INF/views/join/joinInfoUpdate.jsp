...
<head>
	<meta charset="UTF-8">
	<title>Mood Ritual - 회원정보수정</title>
	...
	<form name="myForm" method="post">
		<table class="table table-bordered" style="margin-bottom:30px;">
			<tr>
				...
				<td>
					<div style="width:30%; float:left; margin-right:10px;">
						<input type="text" id="mid" name="mid" class="form-control" value="${vo.mid}" readonly/>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div style="width:30%; float:left; margin-right:10px;">
						<input type="password" class="form-control" id="pwd" name="pwd" placeholder="수정하실 비밀번호를 입력하세요." autofocus />
					</div>
					&nbsp;(영문대소문자/숫자 4~20자)
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div style="width:30%; float:left; margin-right:10px;">
						<input type="text" class="form-control" id="name" name="name" value="${vo.name}" placeholder="이름을 입력하세요."/>
					</div>
					&nbsp;(한글/영문대소문자)
				</td>
			</tr>
				...
				<td>
					<div style="width:50%;">
						<div class="input-group mb-1">
							<input type="text" name="postcode" value="${addressArr[0]}" id="sample6_postcode" placeholder="우편번호" class="form-control" readonly>
						...
						<input type="text" name="roadAddress" value="${addressArr1[0]}" id="sample6_address" size="50" placeholder="주소" class="form-control mb-1" readonly>
						<div class="input-group mb-1">
							<input type="text" name="detailAddress" value="${addressArr1[1]}" id="sample6_detailAddress" placeholder="상세주소" class="form-control"> &nbsp;&nbsp;
							<div class="input-group-append">
								<input type="text" name="extraAddress" value="${addressArr[2]}" id="sample6_extraAddress" placeholder="참고항목" class="form-control" readonly>
							</div>
						</div>
					</div>
				</td>
				...
				<td class="form-inline">
					<div style="float:left;">
						<select name="tel1" id="tel1" class="custom-select form-control">
							...
							<option value="017" ${telArr[0] == '017' ? 'selected' : ''}>017</option>
							<option value="018" ${telArr[0] == '018' ? 'selected' : ''}>018</option>
							<option value="019" ${telArr[0] == '019' ? 'selected' : ''}>019</option>
						</select>&nbsp;&nbsp;-&nbsp;&nbsp;
					</div>
					<input type="text" class="form-control" value="${telArr[1]}" id="tel2" name="tel2" size=4 maxlength=4 style="width:10%;"/>&nbsp;&nbsp;-&nbsp;&nbsp;
					<input type="text" class="form-control" value="${telArr[2]}" id="tel3" name="tel3" size=4 maxlength=4 style="width:10%;"/>
				</td>
			</tr>
			<tr>
				...
				<td style="height:68.5px;">
					<div class="input-group mb-3" style="width:40%; float:left;">
						<input type="text" class="form-control mr-2" value="${emailArr[0]}" oninput="emailCheck()" placeholder="Email을 입력하세요." id="email1" name="email1" required />
						<div class="input-group-append">
							<select name="email2" id="email2" class="custom-select mr-2" onchange="emailCheck()">
								<option value="naver.com" ${emailArr[1] == 'naver.com' ? 'selected' : ''}>naver.com</option>
								<option value="gmail.com" ${emailArr[1] == 'gmail.com' ? 'selected' : ''}>gmail.com</option>
								<option value="hanmail.net" ${emailArr[1] == 'hanmail.net' ? 'selected' : ''}>hanmail.net</option>
								<option value="nate.com" ${emailArr[1] == 'nate.com' ? 'selected' : ''}>nate.com</option>
								<option value="yahoo.com" ${emailArr[1] == 'yahoo.com' ? 'selected' : ''}>yahoo.com</option>
							</select>
						</div>
					</div>
					<span id="email_none" style="display:none;">&nbsp;&nbsp;<font color="red">이메일을 작성해주세요.</font></span>
					<span id="email_ok" style="display:inline-block;">&nbsp;&nbsp;<font color="red">사용 가능한 이메일입니다.</font></span>
			...
			<tr>
				<td>생년월일</td>
				<td class="form-inline">
					<input type="text" class="form-control" id="yy" name="yy" maxlength=4 style="width:10%;" placeholder="년(4자)" value="${birthdayArr[0]}" />&nbsp;&nbsp;
					<div style="float:left; width:10%;">
						<select id="mm" name="mm" class="custom-select form-control" style="width:100%;">
							<option>월</option>
							<c:forEach var="i" begin="1" end="12">
								<option value="${i}" ${birthdayArr[1] == i ? 'selected' : ''}>${i}</option>
							</c:forEach>
						</select>
					</div>&nbsp;&nbsp;
					<input type="text" class="form-control" id="dd" name="dd" maxlength=2 style="width:10%;" placeholder="일" value="${birthdayArr[2]}" />
				</td>
			</tr>
			<tr>
				<td>메일 수신여부</td>
				<td>
					<span class="col pl-0"><input type="checkbox" name="mailCheck" id="mailCheck" ${vo.mailCheck == 'YES' ? 'checked' : ''}/> 동의함</span><br/>
					쇼핑몰에서 제공하는 이벤트 소식을 MAIL을 통해 받으실 수 있습니다.
				</td>
			</tr>
		</table>
		<div class="text-center" style="margin-bottom:100px;">
			<input type="button" value="정보수정" onclick="infoCheck()" class="btn btn-outline-dark" style="width:150px;"/>
