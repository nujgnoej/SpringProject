		...
		IMP.request_pay({
		    ...
		    if(paySw == 'no') {
		    	...
		    	location.href='${ctp}/cart/cartView';
					...
					location.href='${ctp}/cart/paymentResult';
		    }
		});
	</script>
	<style>
		...
		#paymentView {
			border: 0;
			padding: 0; 
			background-image: url('https://cosmicmansion.co.kr/web/upload/ddongrim/main2_01.jpg');
			min-height: 100%;
...
<body>
<div class="text-center" id="paymentView"></div>
</body>
</html>