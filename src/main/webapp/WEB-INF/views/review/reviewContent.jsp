...
<div class="container" style="padding-top:100px; min-height:767px;">
	...
	<div style="height:30px; margin:auto; margin-bottom:10px;"><font color="red">*&nbsp;리뷰수정/삭제는 마이페이지에서 가능합니다.&nbsp;&nbsp;</font><input type="button" value="마이페이지" onclick="myPage()" class="btn btn-outline-danger btn-sm mb-1"/><br/></div>
	<table class="table text-center" style="margin-bottom:60px;" id="rcTable">
		<tr>
			<th width="10%">주문번호</th>
		...
		<tr>
			<td><div class="mainImg" style="background-image:url('${ctp}/data/review/${vo.FSName}');"></div></td>
			<td colspan="3">
